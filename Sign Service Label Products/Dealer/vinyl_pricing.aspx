        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row">
                <section class="page-header">
                    <h1>Screen Printed Vinyl Pricing</h1>
                </section>
            </div>

            <!-- =====================================================================================================================================================================
            Digital Printed Vinyl Information Alert!
            =================================================================================================================================================================== -->
            <div class="alert alert-info" role="alert">
                <strong><span class="fa fa-question-circle"></span> Digital Pricing!</strong> Have you tried pricing in our digital pricing page? <a href="digital_vinyl_pricing.aspx" class="btn btn-info"><i class="fa fa-link"></i> Digital Printed Vinyl</a>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-8 col-lg-8">
                <div id="info-panel-pricing" class="panel panel-default">
                    ...
                    <div class="panel-body text-center">
                        ...
                        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#myModal"><i class="fa fa-folder-open"></i> Vinyl Information</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <section class="col-sm-12 col-md-3 col-lg-3">
                                ...
                                <ul id="stock-list">
                                    ...
                                    <li><a href="#hi-tack-white-vinyl">Hi Tack Vinyl</a></li>
