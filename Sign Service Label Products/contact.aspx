    ...
    <div id="page-content" class="container well-background">
        ...
        <div class="row">
            ...
            <section class="col-sm-12 col-md-6 col-lg-5">
                ...
                <asp:TextBox ID="txtContactEmail" runat="server" TextMode="Email" CssClass="form-control" />
                <!-- Validators -->
                ...
                <asp:TextBox ID="txtContactPhone" runat="server" TextMode="Phone" CssClass="form-control" />
                <!-- Validators -->
                ...
                <asp:TextBox ID="txtContactFax" runat="server" TextMode="Phone" CssClass="form-control" />
                ...
                <br />
                <!-- Submit Button -->
                <asp:Button ID="btnContactSubmit" Text="Send Message" OnClick="btnContactSubmit_Click" runat="server" CssClass="btn btn-primary btn-block contact-submit-btn" />
