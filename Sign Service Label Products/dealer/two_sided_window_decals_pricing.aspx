<%@ Page Title="Window Decals Two Sided Pricing - Dealer - Sign Service Label Products" Language="C#" MasterPageFile="~/dealer/DealerLogin.Master" AutoEventWireup="true" CodeBehind="two_sided_window_decals_pricing.aspx.cs" Inherits="Sign_Service_Label_Products.two_sided_window_decals_pricing" %>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row">
                <section class="page-header">
                    <h1>Window Decal Pricing<small> Two Sided</small></h1>
                </section>
            </div>
        ...
        <div class="row">
            ...
            <section class="col-sm-12 col-md-4 col-lg-4">
                ...
                <fieldset class="fieldset-number-of-colors">
                    ...
                    <asp:TextBox ID="txtNumberOfColours" Value="3" runat="server" CssClass="form-control" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtNumberOfColours" runat="server" ErrorMessage="Please Include the Number of Colours"
                        Display="Dynamic" CssClass="label label-danger"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtNumberOfColours" MinimumValue="3" MaximumValue="999" ErrorMessage="Please choose a number that is 3 or higher." Display="Dynamic" CssClass="label label-danger"></asp:RangeValidator>
                    </fieldset>
                <asp:Label Text="Base price includes one colour on each side plus a background colour." runat="server" CssClass="label label-info" />
