<%@ Page Title="" Language="C#" MasterPageFile="~/dealer/DealerLogin.Master" AutoEventWireup="true" CodeBehind="solid_silver_foil_pricing.aspx.cs" Inherits="Sign_Service_Label_Products.dealer.solid_silver_foil_pricing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container cd-container" id="nav_bar">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row">
                <section class="page-header">
                    <h1>.002 Solid Silver Foil Pricing</h1>
                </section>
            </div>
        ...
        <div class="row">
            ...
            <section class="col-sm-12 col-md-4 col-lg-4">
                ...
                <fieldset>
                    ...
                    <asp:Label ID="lblOverlaminationlabl" Text="Overlamination:" runat="server" />
        ...
        <!-- Solid Silver Foil Information Panel
                =================================================================================================================================================================== -->
        <div id="info-panels" class="row">
            <div class="col-sm-12 col-md-8 col-lg-8">
                <div id="info-panel-pricing" class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="fa fa-book"></span> Vinyl Information
                        </h3>
                    </div>
                    <div class="panel-body text-center">
                        <p>If you would like more information on the stock that you have selected, click "Soild Silver Foil Information".</p>
                        <!-- Vinyl Information trigger to show modal -->
                        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#myModal"><i class="fa fa-folder-open"></i> Soild Silver Foil Information</a>
                    </div>
                </div>
            </div>
        ...
        <!-- =====================================================================================================================================================================
            Soild Silver Foil Information Modal 
            =================================================================================================================================================================== -->
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Soild Silver Foil Information</h4>
                    </div>
                    <div class="modal-body">
                        <p>.002" Solid Silver Foil is a great stampable product, with it's wide variety of uses, it makes an ideal stock choice for anything from asset labels to electric motor ID markings. <br />
                        This product is good for application above 50ºF but once the adhesive has set for 72 hours it can withstand temperatures of -40ºF to +195ºF.</p>
                    </div>
