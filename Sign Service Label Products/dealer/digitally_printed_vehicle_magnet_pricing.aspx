<%@ Page Title="" Language="C#" MasterPageFile="~/dealer/DealerLogin.Master" AutoEventWireup="true" CodeBehind="digitally_printed_vehicle_magnet_pricing.aspx.cs" Inherits="Sign_Service_Label_Products.dealer.digitally_printed_vehicle_magnet_pricing" %>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row">
                <section class="page-header">
                    <h1>Digitally Printed Vehicle Magnet Pricing</h1>
                </section>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-8 col-lg-8">
                <div id="info-panel-pricing" class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="fa fa-book"></span> Digitally Printed Vehicle Magnet Information
                        </h3>
                    </div>
                    <div class="panel-body text-center">
                        <p>If you would like more information on the stock that you have selected, click "Digitally Printed Vehicle Magnet Information".</p>
                        <!-- Vinyl Information trigger to show modal -->
                        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#myModal"><i class="fa fa-folder-open"></i> Digitally Printed Vehicle Magnet Information</a>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Digitally Printed Vehicle Magnet Information</h4>
                    </div>
